...
--- Stats from R4_forward_facing_arrangement_llm_summary_baseline.txt ---

=== REWARD ANALYSIS: R4_forward_facing_arrangement ===

PERFORMANCE METRICS:
  • Success Rate: 0.2% (2/1000 scenes)
  • Mean Reward: nan
  • Median Reward: nan
  • Range: [nan, nan]
  • Std Dev: nan
...
--- Stats from R4_forward_facing_arrangement_llm_summary_dataset.txt ---

=== REWARD ANALYSIS: R4_forward_facing_arrangement ===

PERFORMANCE METRICS:
  • Success Rate: 0.0% (0/813 scenes)
  • Mean Reward: -4.1837
  • Median Reward: -5.0000
  • Range: [-5.0000, 0.0000]
  • Std Dev: 1.6202
  • Percentiles:
      - P1: -5.0000
...
--- Stats from R2_desk_or_table_presence_llm_summary_baseline.txt ---

=== REWARD ANALYSIS: R2_desk_or_table_presence ===
...
--- Stats from R5_adequate_lighting_llm_summary_dataset.txt ---
...
--- Stats from R3_chairs_near_tables_llm_summary_baseline.txt ---

=== REWARD ANALYSIS: R3_chairs_near_tables ===

PERFORMANCE METRICS:
  • Success Rate: 2.4% (24/1000 scenes)
  • Mean Reward: -13.1429
  • Median Reward: -2.2694
  • Range: [-54.0000, -0.0000]
  • Std Dev: 21.2189
  • Percentiles:
      - P1: -54.0000
      - P5: -54.0000
...
--- Stats from R7_uniform_spacing_between_seats_llm_summary_baseline.txt ---

=== REWARD ANALYSIS: R7_uniform_spacing_between_seats ===

PERFORMANCE METRICS:
  • Success Rate: 5.2% (52/1000 scenes)
  • Mean Reward: nan
  • Median Reward: nan
  • Range: [nan, nan]
  • Std Dev: nan
...
--- Stats from R2_desk_or_table_presence_llm_summary_dataset.txt ---
...
--- Stats from R3_chairs_near_tables_llm_summary_dataset.txt ---
...
--- Stats from R1_minimum_student_seating_llm_summary_dataset.txt ---

=== REWARD ANALYSIS: R1_minimum_student_seating ===

PERFORMANCE METRICS:
  • Success Rate: 0.0% (0/813 scenes)
  • Mean Reward: -2.9852
  • Median Reward: -3.0000
  • Range: [-10.0000, 0.0000]
  • Std Dev: 2.2810
  • Percentiles:
      - P1: -8.0000
      - P5: -7.0000
...
--- Stats from R6_storage_furniture_present_llm_summary_dataset.txt ---

=== REWARD ANALYSIS: R6_storage_furniture_present ===
...
--- Stats from R1_minimum_student_seating_llm_summary_baseline.txt ---
...
--- Stats from R6_storage_furniture_present_llm_summary_baseline.txt ---
...
--- Stats from R7_uniform_spacing_between_seats_llm_summary_dataset.txt ---
