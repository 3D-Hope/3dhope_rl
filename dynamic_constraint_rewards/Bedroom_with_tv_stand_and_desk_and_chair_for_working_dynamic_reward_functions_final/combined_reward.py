...
def get_reward(parsed_scenes, idx_to_labels, room_type, floor_polygons, **kwargs):
    ...
    tv_stand_reward = utility_functions["get_object_present_reward_potential"]["function"](
    ...
    num_properly_placed = (tv_stand_reward == 1.0).float() + (desk_reward == 1.0).float() + (chair_reward == 1.0).float()
    ...
    individual_penalties = tv_stand_reward + desk_reward + chair_reward - num_properly_placed
...
def test_reward(idx_to_labels, room_type, floor_polygons, **kwargs):
    ...
    num_objects_1 = 5
    class_label_indices_1 = [19, 7, 4, 8, 12]  # tv_stand, desk, chair, double_bed, nightstand
    translations_1 = [(0, 0.4, 0), (1, 0.4, 1), (1.5, 0.4, 1), (2, 0.5, 2), (-2, 0.3, -2)]
    sizes_1 = [(0.4, 0.4, 0.3), (0.6, 0.4, 0.5), (0.3, 0.4, 0.3), (1.0, 0.5, 1.0), (0.3, 0.3, 0.3)]
    ...
    # Test assertions
    print(f"Scene 1 (all 3 objects properly placed): {rewards[0].item()}, expected: 10.0")
