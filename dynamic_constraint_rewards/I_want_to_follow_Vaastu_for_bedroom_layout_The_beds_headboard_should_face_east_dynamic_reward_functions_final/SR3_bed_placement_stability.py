...
def get_reward(parsed_scenes, idx_to_labels, room_type, floor_polygons, **kwargs):
    ...
    - Baseline: 98.5% success rate, mean 0.992 - model learned this very well
    - Dataset: 99.8% success rate, mean 0.9996 - real scenes have correct placement
    - This constraint is already well-learned, keep as is
    ...
    for b in range(B):
        ...
        for bed_idx in bed_indices:
            ...
            if deviation <= tolerance:
                ...
                # Exponential decay with capped minimum
                normalized_dev = (deviation - tolerance) / 0.5
...
def test_reward(idx_to_labels, room_type, floor_polygons, **kwargs):
    ...
    translations_2 = [(0, 1.0, 0), (1.5, 0.3, 0), (-1.5, 0.5, 0)]
    ...
    translations_3 = [(0, 0.5, 0), (1.5, 0.3, 0), (-1.5, 0.5, 0)]
