...
with open("/media/ajad/YourBook/AshokSaugatResearchBackup/AshokSaugatResearch/ThreedFront/dataset_files/all_rooms_info.json", "w") as f:
    json.dump({"bedroom": {"unique_values": bedroom_unique, "num_classes": len(bedroom_unique), "room_type": "bedroom", "max_objects": 12}, "library": {"unique_values": library_unique, "num_classes": len(library_unique), "room_type": "library", "max_objects": 21}, "livingroom": {"unique_values": livingroom_unique, "num_classes": len(livingroom_unique), "room_type": "livingroom", "max_objects": 21}}, f, indent=2)