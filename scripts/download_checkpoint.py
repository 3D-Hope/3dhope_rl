...
def main():
    ...
    # Parse arguments
    parser = argparse.ArgumentParser(description="Download the latest checkpoint from a wandb run")
    parser.add_argument("--run_id", type=str, required=True, help="The wandb run ID")
    parser.add_argument("--entity", type=str, default="078bct021-ashok-d", help="The wandb entity")
    parser.add_argument("--project", type=str, default="3dhope_rl", help="The wandb project")
    parser.add_argument("--output_dir", type=str, default="./checkpoints", help="Directory to save the checkpoint")
    parser.add_argument("--use_best", action="store_true", help="Download the best checkpoint instead of the latest")
